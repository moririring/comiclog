...
class ComicsControllerTest < ActionController::TestCase
  ...
  test "should create comic" do
    assert_difference('Comic.count') do
      post :create, comic: { author: @comic.author, comic_name: @comic.comic_name, id: @comic.id, publisher: @comic.publisher }
    end
  ...
  test "should update comic" do
    put :update, id: @comic, comic: { author: @comic.author, comic_name: @comic.comic_name, id: @comic.id, publisher: @comic.publisher }
    assert_redirected_to comic_path(assigns(:comic))
  end
